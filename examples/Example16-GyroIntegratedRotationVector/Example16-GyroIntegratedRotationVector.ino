...
//  // Start i2c and BNO085
//  Wire.flush();   // Reset I2C
//  IMU.begin(BNO085_DEFAULT_ADDRESS, Wire);
//  Wire.begin(4, 5);
...
//  //=================================
  ...
  {
    Serial.println("BNO085 not detected at default I2C address. Check your jumpers and the hookup guide. Freezing...");
    while (1);
  }

  Wire.setClock(400000); //Increase I2C data rate to 400kHz

  myIMU.enableGyroIntegratedRotationVector(50000); //Send data update every 50ms
